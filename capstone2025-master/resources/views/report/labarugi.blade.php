<x-reportlayout>
    ...
    <div class="filter px-4 mt-4">
        <form method="GET" action="{{ route('report.labarugi') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        <div>
    ...
    {{-- Ringkasan Kartu --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-5 mb-2 px-4">
        ...
        <p class="text-black text-center font-semibold">{{ 'Rp ' . number_format( $totalBiaya, 0, ',', '.') }}</p>
        </div>
        ...
        <p class="text-black text-center font-semibold">{{ 'Rp ' . number_format( $labaBersih, 0, ',', '.') }}</p>
        </div>
    </div>
</x-reportlayout>